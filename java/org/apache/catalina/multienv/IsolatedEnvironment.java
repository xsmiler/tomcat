 ...
 */
package org.apache.catalina.multienv;
...
public class IsolatedEnvironment extends AbstractMap<String, String> {
    ...
    private static Method                  GET_READ_KEY_PREFIX_METHOD;
...
//        return readKeyPrefix(tccl);
    ...
    protected String readKeyPrefix(ClassLoader classLoader) {
        ...
        if (classLoader != null) {
            try {
                if (GET_READ_KEY_PREFIX_METHOD == null) {
                    GET_READ_KEY_PREFIX_METHOD = classLoader.getClass().getMethod("getReadKeyPrefix");
                }
                String value = (String)GET_READ_KEY_PREFIX_METHOD.invoke(classLoader);
                if (value != null) {
                    return value;
                }
